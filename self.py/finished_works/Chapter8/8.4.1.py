# Towards the end of the development of the game "Hanged Man"
# we had to go back and print each time one of the status images of the hanging man, 
# depending on the number of wrong guesses the player guessed.

# For this purpose, follow the following instructions:

# Define a constant variable called HANGMAN_PHOTOS. 
# The variable is of dictionary type (dict) and must hold the seven states of the hanging man 
# (which you encountered in the unfolding task at the end of Unit 1).
