...
# My Solution
def read_file(file_name):
    final_msg=['__CONTENT_START__']
    try:
        with open(file_name) as file:
            data= file.read()
    except:
        final_msg.append('__NO_SUCH_FILE__')
    else:
        final_msg.append(data)
    finally:
        final_msg.append('__CONTENT_END__')
    return "\n\n".join(final_msg)

print(read_file(r"C:\Users\david\OneDrive\Desktop\next.py\test_text.txt")) # file path here.